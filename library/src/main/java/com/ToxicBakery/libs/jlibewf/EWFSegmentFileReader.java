...
public class EWFSegmentFileReader {
     ...
     */
    protected static String makeByteLog(String text, byte[] bytes) {
     ...
     * @param fileOffset the byte offset address in the file to read from
     * @param numBytes   the number of bytes to read
     * @throws EWFIOException If the bytes cannot be read or if the Adler32 checksum fails
     */
     ...
     * @param fileOffset the byte offset address in the file to read from
     * @param numBytes   the number of bytes to read
     * @throws EWFIOException If the bytes cannot be read or if the decompression fails
     */
